...
def parse_args():
    ...
    parser.add_argument('--context_model', type=str, default='resnet18', choices=['resnet18', 'resnet50', 'densenet161'], help='context model type')
    parser.add_argument('--body_model', type=str, default='resnet18', choices=['resnet18', 'resnet50', 'densenet161'], help='body model type')
    parser.add_argument('--weights', type=str, default='places365', choices=['places365', 'imagenet'], help='model weights type')
